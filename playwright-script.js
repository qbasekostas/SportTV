                   ...
                   console.log("\x1b[35m Waiting for Clappr Video element:", videoSelector,'\x1b[0m');
                    await page.waitForSelector(videoSelector, { timeout: CLAPPR_TIMEOUT });
                      console.log("\x1b[32m Clappr video element loaded. \x1b[0m");
                        ...
                        console.log("\x1b[33mTimeout waiting for Clappr video element, attempting manual initialization \x1b[0m");
                      try {
                            await page.evaluate(() => {
                            ...
                            try{
                                   await page.waitForSelector('#player > div > div.container[data-container] > video', { timeout: CLAPPR_TIMEOUT });
                                     console.log("\x1b[32m Video element loaded after manual initialization.\x1b[0m");
                             }catch(e3){
                                console.log("\x1b[33m Timeout waiting for video element after manual Clappr initialization.\x1b[0m");
                              }
                      }catch(e2){
