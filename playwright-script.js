            ...
            try {
                ...
                // Initialize the console-ban script with some specific options to prevent redirection
                  ...
                  console.log("\x1b[32m Console-ban script initialized. \x1b[0m");
                   ...
                   // Wait for the Clappr player script element
                  try{
                      const playerScriptSelector = '#player > div > script';
                       console.log('\x1b[35m Waiting for player script:',playerScriptSelector,'\x1b[0m');
                     await page.waitForSelector(playerScriptSelector,{timeout:CLAPPR_TIMEOUT});
                     console.log("\x1b[32m Clappr player script found.\x1b[0m");

                    } catch (e){
                     console.log("\x1b[33mTimeout waiting for player script. Using generic regex fallback.\x1b[0m");
                       ...
                       if (genericMatch && genericMatch[0]) {
                           ...
                           console.log("\x1b[33mCould not get the M3U8 url by generic regex.\x1b[0m",targetUrl);
