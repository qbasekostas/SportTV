            ...
            try {
                ...
                await page.goto(targetUrl, { waitUntil: 'networkidle2' });
                  ...
                  // Wait for the video tag and src attribute
                    let videoElement, videoSrc;
                 try {
                     await page.waitForFunction(() => {
                        const video = document.evaluate('//video | //video[@data-html5-video]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
                        ...
                        if(videoElement){
                             videoSrc = await page.evaluate((el) => el.src, videoElement);
                         ...
                         console.error("\x1b[31mError waiting for video element (waitForFunction):\x1b[0m", targetUrl, e);
                     }
